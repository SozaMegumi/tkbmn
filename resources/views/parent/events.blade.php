...
@section('content')
<style>
    .card-soft { border: none; border-radius: 20px; box-shadow: 0 4px 20px rgba(0,0,0,0.04); background: #fff; overflow: hidden; }
    .notice-card { border-left: 5px solid #0d6efd; transition: all 0.2s; background: #f8fafc; border-radius: 15px; }
...
<div class="container-fluid pb-5">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h3 class="fw-bold text-dark mb-1">{{ __('messages.school_calendar_notices') }}</h3>
            <p class="text-muted small mb-0">{{ __('messages.academic_events_overview') }}</p>
        </div>
        <div class="text-end">
        ...
        <div class="col-lg-8">
            <div class="card card-soft h-100">
                <div class="card-header bg-white p-4 border-0 d-flex justify-content-between align-items-center">
                    <h5 class="mb-0 fw-bold text-dark"><i class="bi bi-google text-primary me-2"></i> {{ __('messages.official_live_calendar') }}</h5>
                    <span class="badge bg-primary bg-opacity-10 text-primary border border-primary border-opacity-25 rounded-pill px-3 py-2">{{ __('messages.real_time_sync') }}</span>
                </div>
        ...
        <div class="col-lg-4">
            <div class="card card-soft h-100" style="border-top: 5px solid #0d6efd;">
                <div class="card-header bg-white p-4 border-0">
                    <h5 class="fw-bold text-dark mb-0"><i class="bi bi-megaphone me-2 text-warning"></i> {{ __('messages.upcoming_activities') }}</h5>
                </div>
                <div class="card-body p-0" style="max-height: 600px; overflow-y: auto;">
                    <div class="list-group list-group-flush px-2 pb-3">
                        ...
                        <div class="text-center p-5 text-muted">
                            ...
                            <p class="mt-3 mb-0 small fw-bold">{{ __('messages.no_upcoming_events_parent') }}</p>
                        </div>
                        @endforelse
                    </div>
                </div>

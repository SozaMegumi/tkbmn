...
<div class="container-fluid pb-4 h-100">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            ...
            <p class="text-muted small mb-0">Stay in touch with teachers.</p>
        </div>
    </div>
        ...
        <div class="contact-list-column">
            <div class="search-box-area">
                <div class="input-group">
                    ...
                    <input type="text" class="form-control bg-light border-start-0 rounded-end-pill" placeholder="Search teacher...">
                </div>
            </div>
            ...
            <div class="contact-scroll-area">
                ...
                @empty
                    <div class="text-center p-4 text-muted">No teachers found.</div>
                @endforelse
            </div>
        </div>
        ...
        <div class="chat-window-column">
            ...
            @else
                <div class="d-flex flex-column align-items-center justify-content-center h-100 text-muted">
                    ...
                    <h5 class="fw-bold text-dark">Select a Teacher</h5>
                    <p class="small">Choose a teacher from the sidebar to start chatting.</p>
                </div>
            @endif
        </div>

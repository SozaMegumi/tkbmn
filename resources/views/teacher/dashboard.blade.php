...
<div class="container-fluid pb-5">
    ...
    <div class="card card-soft bg-primary text-white mb-4" style="background: url('https://www.transparenttextures.com/patterns/cubes.png'), linear-gradient(135deg, #0d6efd 0%, #0dcaf0 100%);">
        <div class="card-body p-4 d-flex justify-content-between align-items-center">
            <div>
                <h3 class="fw-bold mb-1">Welcome back, {{ auth()->user()->full_name ?? 'Cikgu Munirah' }}!</h3>
                <p class="mb-0 opacity-75">
                    <i class="bi bi-shop-window me-1"></i> Assigned Class: <strong>{{ $assignedClass ?? 'Kelas Mawar (6 Years)' }}</strong>
                </p>
            </div>
    ...
    <div class="row g-4 mb-4">
        <div class="col-md-4">
            <div class="card card-soft bg-gradient-primary h-100 p-4 position-relative">
                <span class="stat-label mb-2"><i class="bi bi-people-fill me-2"></i> My Students</span>
        ...
        <div class="col-md-4">
            <div class="card card-soft {{ ($attendanceMarked ?? false) ? 'bg-gradient-success' : 'bg-gradient-warning' }} h-100 p-4 position-relative">
                <span class="stat-label mb-2"><i class="bi bi-calendar-check me-2"></i> Today's Attendance</span>
                <h3 class="fw-bold mb-0 mt-2">
                    {{ ($attendanceMarked ?? false) ? 'Completed' : 'Action Required' }}
                </h3>
        ...
        <div class="col-lg-8">
            <div class="card card-soft bg-white h-100">
                <div class="card-header bg-white p-4 border-0">
                    <h5 class="fw-bold mb-0 text-dark"><i class="bi bi-list-task text-primary me-2"></i> My Pending Tasks</h5>
                </div>
        ...
        <div class="col-lg-4">
            <div class="card card-soft bg-white h-100">
                <div class="card-header bg-white p-4 border-0 d-flex justify-content-between align-items-center">
                    <h6 class="fw-bold mb-0 text-dark">School Announcements</h6>
                </div>
                <div class="card-body p-0">
